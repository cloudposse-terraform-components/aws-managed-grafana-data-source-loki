...
| <a name="module_source_account_role"></a> [source\_account\_role](#module\_source\_account\_role) | github.com/cloudposse-terraform-components/aws-account-map//src/modules/iam-roles | tags/v1.535.3 |
